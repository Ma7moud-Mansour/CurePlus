"""
Django settings for CurePlus project.
...
SECRET_KEY = 'django-insecure-c*h=-o)zn)2+5e-tm!@9eu0j-diy^^*9pt10*$#61kt2efyup5'
...
WSGI_APPLICATION = 'CurePlus.wsgi.application'
